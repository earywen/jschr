...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        // Executive Dark style — Premium fintech aesthetic
        "bg-card text-card-foreground flex flex-col gap-6 rounded-3xl border border-white/5 p-8 shadow-2xl shadow-black/20",
        className
      )}
      {...props}
    />
